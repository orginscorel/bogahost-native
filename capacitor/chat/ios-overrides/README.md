...
| `apple-app-site-association` | CANLI siteye: `https://chat.bogahost.com/.well-known/apple-app-site-association` | **ELLE** (sunucu dosyası) |
...
1. **Team ID** — `apple-app-site-association` içindeki `TEAMID` yer tutucusunu
   ...
   ```json
   "appID": "A1B2C3D4E5.com.bogahost.chat"
   ```
...
2. **.well-known yayını** — dosyayı CANLI siteye **uzantısız** ve
   ...
   `https://chat.bogahost.com/.well-known/apple-app-site-association`
