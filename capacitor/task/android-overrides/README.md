# Android overrides — Bogahost Görevler
...
| `assetlinks.json` | `https://task.bogahost.com/.well-known/assetlinks.json` |
...
2. **assetlinks.json**: SHA256 parmak izini yaz ve
   `task.bogahost.com/.well-known/assetlinks.json` altında yayınla.
