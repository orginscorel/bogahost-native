...
| `apple-app-site-association` | CANLI siteye: `https://finans.bogahost.com/.well-known/apple-app-site-association` | **ELLE** (sunucu dosyası) |
...
1. **Team ID** — `apple-app-site-association` içindeki `TEAMID` yer tutucusunu
   ...
   ```json
   "appID": "A1B2C3D4E5.com.bogahost.finans"
   ```
