# Android overrides — Bogahost DCIM
...
| `assetlinks.json` | `https://dcim.bogahost.com/.well-known/assetlinks.json` |
...
2. **assetlinks.json**: SHA256 parmak izini yaz ve
   `dcim.bogahost.com/.well-known/assetlinks.json` altında yayınla.
